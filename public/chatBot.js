...
(function () {
  ...
  <div id="chat-messages" style="flex:1; padding:12px;overflow-y:auto; background:#f9fafb; display:flex; flex-direction:column; font-size:13px;">
  </div>

  <div style="display:flex; border-top:1px solid #e5e7eb; padding:8px; gap:6px">
    <input 
    id="chat-input"
    style="flex:1; padding:8px 10px; border-radius:8px; font-size:13px; outline:none"
    type="text"
